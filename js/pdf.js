...
class InternalRenderTask {
  ...
  initializeGraphics({
    ...
    this.gfx.overrideColor = overrideColor;
...
class CanvasGraphics {
  ...
  setStrokeRGBColor(r, g, b) {
    ...
    if (this.overrideColor && (this.overrideColor[color] || this.overrideColor['*'])) {
      if (this.overrideColor[color]) {
        color = this.overrideColor[color];
      } else {
